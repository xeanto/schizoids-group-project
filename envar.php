...
<main>
	...
	<ul>
		<p>To view the list of environment variables in your system, use the command <b>‘printenv’</b> or
			<b>‘env’</b>. This will display a list of all the environment variables and their values.
		</p>
	</ul>
	<br>
	<h3>Setting environment variables: </h3>
	<ul>
		<p>To set an environment variable, use the <b>‘export’</b> command followed by the variable name and value.
	...
	<ul>
		<p>To unset an environment variable, use the <b>‘unset’</b> command followed by the variable name. For
			example, to unset the <b>‘PATH’</b> variable, use the command <b>‘unset PATH’</b>.</p>
	</ul>
	<br>
	<h3>Using environment variables: </h3>
	<ul>
		<p>Environment variables can be used in many ways in Unix. For example, you can use the <b>‘HOME’</b> variable
	...
	<ul>
		<p>To make environment variables persistent across sessions, you can add them to the appropriate startup file
...
$quizQuestions = [
	0 => "What command can you use to set the value of an environment variable?",
	1 => "What is the name of the environment variable that stores the current user's home directory?"
];
$quizAnswers = [
	0 => [
		0 => "export",
